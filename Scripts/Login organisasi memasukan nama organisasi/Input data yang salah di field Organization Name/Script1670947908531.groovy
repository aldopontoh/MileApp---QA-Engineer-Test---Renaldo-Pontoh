...
WebUI.setText(findTestObject('Page_MileApp_Login/txtField_Organization_Name'), GlobalVariable.invalid_org_name)

WebUI.sendKeys(findTestObject('Page_MileApp_Login/txtField_Organization_Name'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Page_MileApp_Login/txt_The_organization_field_is_required'), 2)
