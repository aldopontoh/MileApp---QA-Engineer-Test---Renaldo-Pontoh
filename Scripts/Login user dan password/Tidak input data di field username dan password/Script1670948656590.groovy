...
WebUI.verifyElementPresent(findTestObject('Page_MileApp_Login/errorMessage_The_email_or_username_field_is_required'), 0)

WebUI.verifyElementPresent(findTestObject('Page_MileApp_Login/errorMessage_The_password_field_is_required'), 0)
