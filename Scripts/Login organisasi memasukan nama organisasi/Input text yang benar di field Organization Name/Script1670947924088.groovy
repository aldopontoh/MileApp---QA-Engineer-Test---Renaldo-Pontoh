...
WebUI.verifyElementVisible(findTestObject('Page_MileApp_Login/txtField_username'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Page_MileApp_Login/txtField_Password'))
